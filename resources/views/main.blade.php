...
@section('content')
	<div id="content" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<span class="titleContent">Наиболее популярные сорта культур</span>
		
		
		@foreach($products as $product)
		<div class="product col-lg-12 col-md-12 col-sm-12 col-xs-12" >
			<p class="name_product col-lg-4 col-md-4 col-sm-12 col-xs-12"><a href="product/{{ $product['product_id'] }}">{{ $product['product_name'] }}</a></p>
			<p class="prise_product col-lg-2 col-md-2 col-sm-4 col-xs-4">{{ $product['price'] }} грн/т</p>
			
			
			<form>
			<p class="count_product col-lg-2 col-md-2 col-sm-4 col-xs-4">
			...
			<p class="to_cart col-lg-2 col-md-2 col-sm-4 col-xs-4">
			...
			<p class="to_product col-lg-2 col-md-2 col-sm-4 col-xs-4">
